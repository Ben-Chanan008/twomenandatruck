...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/benchanan/Documents/Dev/twomenandatruck/public/storage' => 'string',
...
'filesystems.links./home/benchanan/Documents/Dev/twomenandatruck/public/storage','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','tinker.commands','tinker.alias','tinker.dont_alias',);
        registerArgumentsSet('middleware', 
'web','api','auth','auth.basic','auth.session',
'cache.headers','can','guest','password.confirm','precognitive',
'signed','throttle','verified','user-access',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','home','moving','us',
'signup.view','signin.view','logout','sign-up','sign-in',
'dashboard','admin.quote.create','quote.store','quote.create','admin.quote.index',
'storage.local',);
        registerArgumentsSet('views', 
'about','admin.create-quote','admin.dashboard','admin.quote','components.base-struct',
'components.button','components.circles','components.dashboard-navbar','components.footer','components.gold-button',
'components.modal','components.msg','components.navbar','components.popup','components.side-bar',
'dashboard','home','login','onboarding','services.moving',
'team','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor','laravel-exceptions-renderer::components.header',
